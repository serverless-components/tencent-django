...
component: django # (必选) 组件名称，在该实例中为django
name: djangoDemo # 必选) 组件实例名称.
...
inputs:
  ...
  functionName: djangoDemo # 云函数名称
  serviceName: mytest # api网关服务名称
  djangoProjectName: mydjangocomponent # django 应用名称
...
| djangoProjectName                    |    是    |                 | django 应用名称                                                |
